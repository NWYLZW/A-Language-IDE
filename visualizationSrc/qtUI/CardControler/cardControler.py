...
"}")
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(20, 10, 1081, 51))
...
"}")
        ...
        self.cardScroll.setGeometry(QtCore.QRect(20, 70, 1081, 521))
        ...
        self.cardScrollWidget.setGeometry(QtCore.QRect(0, 0, 1069, 2000))
        ...
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.CardList)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(720, 600, 381, 41))
        ...
        self.toFirstBtn = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
...
"}")
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 341, 39))
